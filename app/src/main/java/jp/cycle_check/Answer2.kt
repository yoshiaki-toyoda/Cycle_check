...
class Answer2Activity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Answer_info = extras.get("answerinfo") as Answer_question2

        val bytes = Answer_info.imageBytes
        val report_type = Answer_info.report_type
        var report = ""
        ...
        val answer_type = Answer_info.answer_type
        var answer = ""
        ...
        val old_type = Answer_info.old_type
        var old = ""
        ...
        Titile_ditail.text = Answer_info.title
        user_name.text ="質問者名："+Answer_info.name
        area_name.text = "質問者地域："+Answer_info.area
        cycle_name.text = "自転車名："+Answer_info.cycle_name
        shopText.text = "購入店："+Answer_info.shop_ID
        disText.text = "走行距離："+Answer_info.distance+"km"
        Report_typetext.text ="回答タイプ："+ report
        part_name.text = "相談部品："+Answer_info.part
        problem_edit.text = Answer_info.problem
        reportAnsertext.text = answer
        type_otheretext.text = Answer_info.other_request
        yosan_text.text = Answer_info.yosan
        oldpart_text.text = old
        com_edit.text = Answer_info.com
    ...
    override fun onClick(v: View) {
        if (v === imageView5) {
            ...
            val cycle_uid=Answer_info.cycleUid
